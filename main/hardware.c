...
void enable_wifi_agc_openmac() {
	...
	write_register(0x3ff5c038, esp_dport_access_reg_read(0x3ff5c038) & 0x4000000);
}
// [[openmac-coverage:implemented]]
void disable_wifi_agc_openmac() {
	write_register(0x3ff5c01c, (esp_dport_access_reg_read(0x3ff5c01c) & 0xff00ffff) | 0x7f0000);
	write_register(0x3ff5c038, esp_dport_access_reg_read(0x3ff5c038) & 0x4000000);
	write_register(0x3ff5c030, esp_dport_access_reg_read(0x3ff5c030) & 0xffffffcf);
	write_register(0x3ff5c080, esp_dport_access_reg_read(0x3ff5c080) & 0x1);
}
